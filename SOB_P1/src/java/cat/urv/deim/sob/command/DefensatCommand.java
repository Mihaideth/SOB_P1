 ...
 */
public class DefensatCommand implements Command {
    ...
    @Override
     public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            tfg.setQualificacio(request.getParameter("qualificacio"));
            ...
            try {
                ...
                Logger.getLogger(DefensatCommand.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void insertTfg(Tfg tfg, HttpSession sessionUser, LinkedList ll) throws SQLException, ClassNotFoundException, NamingException {
        ...
        try (Statement stmt = con.createStatement()) {
            ...
            stmt.execute("INSERT INTO sob_grup_05.TFG(TITLE, DESCR, STATE, ESTUDIANTS, ESTUDIS, RECURSOS, DATADEFENSA, QUALIFICACIO, DATACREACIO, DATAMODIFICACIO) VALUES ('"+tfg.getTitol()+"', '"+tfg.getDescripcio()+"', '"+tfg.getEstat()+"', '"+tfg.getEstudiants()+"', '"+tfg.getEstudis()+"', '"+tfg.getRecursos()+"', '"+tfg.getDataDefensa()+"', '"+tfg.getQualificacio()+"', '"+data+"' , '"+data+"')");
